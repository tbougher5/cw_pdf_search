...
prdDFlist = [['All Products','DF_All_Products_v3.sav'], ['Architectural Windows', 'DF_Architectural_Windows.sav'], ['Curtain Wall', 'DF_Curtain_Wall.sav'],['Entrances','DF_Entrances_v3.sav'],['Storefront','DF_Storefront_v3.sav'],['Window Wall','DF_Window_Wall.sav']]
