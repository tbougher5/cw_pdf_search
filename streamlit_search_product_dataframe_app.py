...
prdDFlist = [['All Products','DF_All_Products_v4b.sav'], ['Architectural Windows', 'DF_Architectural_Windows_v4.sav'], ['Curtain Wall', 'DF_Curtain_Wall_v4.sav']\
...
def run_search():
    ...
    #        break'
    dfFile = 'DF_All_Products_v4b.sav'
